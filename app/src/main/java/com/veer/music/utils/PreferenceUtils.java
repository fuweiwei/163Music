...
public class PreferenceUtils {
    ...
    public static final String MUSIC_TYPE_KEY = "163Music";

    private PreferenceUtils(Context context){
        sharedPreferences = context.getSharedPreferences(MUSIC_TYPE_KEY, Context.MODE_PRIVATE);
